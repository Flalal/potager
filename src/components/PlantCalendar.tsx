  ...
  return (
    <section className="rounded-xl border border-emerald-100 bg-white p-4">
      <div className="mb-3 flex items-center justify-between">
        <h2 className="font-bold text-emerald-900">Calendrier</h2>
      ...
      <div className="space-y-2">
        {ORDER.map((action) => (
          <div key={action} className="flex items-center gap-2">
            <span className="w-24 shrink-0 text-sm font-medium text-emerald-800">
                  ...
                  <div
                    ...
                    className={`flex h-7 flex-1 items-center justify-center rounded text-[10px] ${
                      active
                        ...
                        : "bg-emerald-50/50 text-emerald-700/30"
                    }`}
                  >
                    {m[0]}
                  </div>
